...
public class UseStudent {
	...
	public static void main(String[] args) {
		...
		List<Integer>list=li.stream().map(a->a.getDob()).collect(Collectors.toList());
		list.forEach(abcd->System.out.println(abcd));
		...
		List<String> lo=li.stream().map(y->y.getDept()).collect(Collectors.toList());
		lo.forEach(abc->System.out.println(abc));
